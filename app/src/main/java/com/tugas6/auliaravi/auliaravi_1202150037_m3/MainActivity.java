...
public class MainActivity extends AppCompatActivity {
    ...
    private void initializeData() {
        ...
        for(int i=0;i<watersList.length;i++){
            String[] judul = {"Aqua", "Amidis", "Ades", "Cleo", "Club", "Equil",
                    "Evian", "Leminerale", "Pristine", "Vit", "Nestle"};
            //pembuatan nama merk n=
            mWaterData.add(new water(judul[i], "Air minum merk "+judul[i], "Air mineral yang bersih dan alami, berasal dari mata air gunung alami " +
                    "air mineral dengan kemasan praktis dan menggunakan program gogreen untuk membatu ekosistem dunia" ,
                    watersImageRes.getResourceId(i,0)));
            //detail yang akan di tanyangkan pada halaman detail
        }
